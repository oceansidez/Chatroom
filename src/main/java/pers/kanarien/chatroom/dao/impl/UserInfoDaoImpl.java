...
public class UserInfoDaoImpl implements UserInfoDao {
    ...
    public void loadUserInfo() {
        // 设置用户基本信息，共9个用户
        UserInfo userInfo = new UserInfo("001", "zzh", "123456", "static/img/avatar/Member001.jpg");
        UserInfo userInfo2 = new UserInfo("002", "lyj", "123456", "static/img/avatar/Member002.jpg");
        UserInfo userInfo3 = new UserInfo("003", "cz", "123456", "static/img/avatar/Member003.jpg");
...
//        userInfo9.setGroupList(groupList);
        ...
        Constant.userInfoMap.put("zzh", userInfo);
        Constant.userInfoMap.put("lyj", userInfo2);
        Constant.userInfoMap.put("cz", userInfo3);
